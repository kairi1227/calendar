...
function onStandaloneSelect(value) {
  console.log('week-calendar select', (value && value.format(format)));
}

function onStandaloneChange(value) {
  console.log('week-calendar change', (value && value.format(format)));
}
...
ReactDOM.render(
  ...
  >
    <WeekCalendar
      ...
      weekCellContentRender={onWeekCellContentRender}
