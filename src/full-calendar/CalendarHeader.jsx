...
class CalendarHeader extends Component {
  ...
  weekSelectElement() {
    ...
    for (let index = 1; index <= t.daysInMonth(); index++) {
      options.push(
        <Select.Option key={`${index}`}>
          {index}
        </Select.Option>
